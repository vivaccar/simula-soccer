...
class	League(models.Model):
	...
	zone_2_txt = models.CharField(max_length=150, default=None, null=True, blank=True)
	zone_3 = models.IntegerField(default=None, null=True, blank=True)
	zone_3_txt = models.CharField(max_length=150, default=None, null=True, blank=True)
	zone_4 = models.IntegerField(default=None, null=True, blank=True)
	zone_4_txt = models.CharField(max_length=150, default=None, null=True, blank=True)
	zone_5 = models.IntegerField(default=None, null=True, blank=True)
	zone_5_txt = models.CharField(max_length=150, default=None, null=True, blank=True)
	zone_reb = models.IntegerField(default=None, null=True, blank=True)
	zone_reb_txt = models.CharField(max_length=150, default=None, null=True, blank=True)
